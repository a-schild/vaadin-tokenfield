...
import org.aarboard.tokenfield.TokenField.InsertPosition;
...
public class DemoRoot extends UI {
    ...
    @VaadinServletConfiguration(productionMode = false, ui = DemoRoot.class)
    ...
    static class Content extends VerticalLayout {
        ...
        Content() {
...

            {
                ...
                lo.addValueChangeListener(new AbstractField.ValueChangeListener() {
                ...
                ip.addValueChangeListener(new AbstractField.ValueChangeListener() {
                ...
                cb.addValueChangeListener(new AbstractField.ValueChangeListener() {
